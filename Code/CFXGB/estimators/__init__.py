...
def get_estimator_kfold(name, n_splits, est_type, est_args, args, random_state=None):
    est_class = get_estimator_class(est_type)
    return KFoldWrapper(name, n_splits, est_class, est_args, args, random_state=random_state)
